...
sed -i '57  a\<role rolename="manager-script"/>' apache-tomcat-11.0.10/conf/tomcat-users.xml
sed -i '58  a\<user username="tomcat" password="admin@123" roles="manager-gui, manager-script"/>' apache-tomcat-11.0.10/conf/tomcat-users.xml
